// Unit tests for the visibility-search-attribute fallback used when an auto claim
...
class AutoClaimVisibilityFallbackTest {
    ...
    void toleratesMissingSearchAttributes() {
        WorkflowExecutionInfo info = WorkflowExecutionInfo.newBuilder()
            .setExecution(WorkflowExecution.newBuilder()
                .setWorkflowId("claim/auto/clm-nodata").build())
            .build();
